 ...
 * Horizontally centred in the space between the viewport edge and the body's
 * left edge, clamped to the viewport edge on narrow screens where the handle
 * runs out.
 *
 ...
 */
export default function GutterRail({
  href,
  label,
  title,
  icon,
